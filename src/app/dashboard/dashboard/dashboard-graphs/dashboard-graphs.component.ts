...
export class DashboardGraphsComponent implements OnInit {
    ...
    constructor(private dashboardlabel: DashboardLabelService, private dashapi: DashboardApiService,
        ...
        private dashboardrx: DashboardRxService, public dialog: MatDialog) {
        this.CSSRKPILabel = "";
        this.CountryLabel = "";
        ...
        this.selectedLang = this.appService.giveSelectedLang();
    ...
    showDetail() {
        this.dashboardservice.shareObject = this.searchObj;
        ...
        if (id == 3) {
            ...
            this.dashboardservice.getSMRConvertedCountDashboard(this.searchObj).subscribe((data) => {
                if (data != null) {
                    ...
                    console.log("service due...maaya1");
                }
            ...
            this.dashboardservice.getFreshLeadCount(this.searchObj).subscribe((data) => {
                if (data != null) {
                    ...
                    console.log("service due...maaya2");
                }
            ...
            this.dashboardservice.getFollowUpLeadCount(this.searchObj).subscribe((data) => {
                if (data != null) {
                    ...
                    console.log("service due...maaya3");
                }
            ...
            this.dashboardservice.getNonContactLeadCount(this.searchObj).subscribe((data) => {
                if (data != null) {
                    ...
                    console.log("service due...maaya4");
                }
            ...
            this.dashboardservice.getBookingLeadCount(this.searchObj).subscribe((data) => {
                if (data != null) {
                    ...
                    console.log("service due...maaya5");
                }
            ...
            this.dashboardservice.getServiceDueVsDoneForVehicle(this.searchObj).subscribe((data) => {
                if (data != null) {
                    ...
                    console.log("service due...maaya6");
                }
            ...
            this.dashboardservice.getServiceDue(this.searchObj).subscribe((data) => {
                if (data != null) {
                    ...
                    console.log("service due...maaya", this.ServiceDue);
    ...
    takeLabelObject() {
        ...
        obs.subscribe(
            (data: any) => {
                console.log("datain graph dashboard is", data);
                this.labelObj = data;
                this.selectLanguage(this.appService.giveSelectedLang());
                console.log("label object in graph label service", this.labelObj.length);
